...
#define BS_UPDATE_DURATION 5*60*MSEC_PER_SEC //5 minutes
...
#define CALLITHRIX_CHR_DATA_NODE            BT_UUID_128_ENCODE(0xd6a11e21, 0xc6e1, 0x49ed, 0x8355, 0x839e6fe3151e)
#define CALLITHRIX_CHR_DATA_ENV             BT_UUID_128_ENCODE(0x06f27084, 0x15c4, 0x46f0, 0xabbf, 0x0ea21ad1699f)
